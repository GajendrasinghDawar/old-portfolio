            ...
            <article className="article-flex-container">
                ...
                <div className="project-divs">
                    ...
                    <dl>
                        ...
                        <dd className="left-dd">
                            I used Django in this project for serving blogs (notes to self) from the backend. However, it still needs some polish. Django is running on <a className="highlight-me" href="http://gajendrasinghdawar.pythonanywhere.com/notes/" target={'_blank'} rel="noopener noreferrer">PythonAnywhere.com</a>.
                        </dd>
                    </dl>
                    <dl>
